        ...
        <div class="col-md-6 offset-3 pt-3">
            <form action="{{route('sliders.store')}} " method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="my-input" class="form-control" type="text" name="sort_title" placeholder="Enter Your Sort_Title">
                    <font style="color:red">{{($errors->has('sort_title'))?($errors->first('sort_title')):''}} </font>
                </div>
                <div class="form-group">
                    <label for="my-input"><span class="text-warning">*</span> Long_Title</label>
