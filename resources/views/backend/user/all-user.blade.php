                    ...
                    <tr>
                        ...
                        <td>
                           @if($item->is_approved==true)
                            <a href="{{route('user.status.reject', $item->id)}}"><span class="badge badge-success">Approved</span></a>
                           @else
                            <a href="{{route('user.status.approve', $item->id)}}"><span class="badge badge-warning">Pending</span></a>
                           @endif
