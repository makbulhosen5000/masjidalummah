        ...
        <div class="col-md-6 offset-3 pt-3">
            <form action="{{(@$editTimer)?route('timers.update',$editTimer->id):route('timers.store')}} " method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="" value="{{@$editTimer->title}}" type="text" placeholder="Enter Your Title">
                    <font style="color:red">{{($errors->has('title'))?($errors->first('title')):''}} </font>
                </div>
                <div class="form-group">
                     <label for="name">Select Date Time <span class="text-danger">*</span></label>
                     <input type="datetime-local" name="date_time" value="{{@$editTimer->date_time}}" class="form-control" required />
                  ...
                  <div class="form-group">
                     ...
                     <select class="form-control" name="timer_status" value="{{@$editTimer->timer_status}}" required>
