...
<div class="card">
        ...
        <div class="card-body ">
            <div class="row">
                <div class="col-md-12  d-flex justify-content-between align-items-center">
                  @if(isset($editData))
                  <h5 class="display-5">Edit Knowloadge</h5>
                    @else
                    <h5 class="display-5">Create Knowloadge</h5>
                  @endif
                  <a href="{{route('knowladges.view')}}" class="btn btn-warning text-dark"> <i class="fa fa-list"></i> Knowladge</a>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 offset-3 pt-3">
            <form action="{{(@$editData)?route('knowladges.update',$editData->id):route('knowladges.store')}} " method="POST" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
