    ...
    <div class="card bg-dark">
            <div class="row">
                <div class="col-md-6 offset-3 pt-5">
                    <h2 class="responsive display-5 text-warning text-center" style="margin-top: 170px;">Registration Form</h2>      
                    {{-- form start --}}
                    <form action="{{route('donate.store')}} " method="POST">
                        ...
                        <div class="form-group">
                            <label for="my-input"><span class="text-warning">*</span>Age</label>
                        ...
                        <div class="form-group">
                            <label for="my-input"><span class="text-warning">*</span>Applicant Signature</label>
